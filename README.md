...
Full Monte-Carlo and Delta-Normal methods.

Finally, we also price a Cliquet options, an exotic option that can be decomposed into a sum of European Calls.

This repo is mainly meant as a trial of use of the functionalities of GitHub and their integration with PyCharm.
It is my first real repository, so I apologise for any error in the use of Github tools.
